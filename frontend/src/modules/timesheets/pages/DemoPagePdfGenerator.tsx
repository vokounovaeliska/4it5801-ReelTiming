...
import PdfReportGenerator from '@frontend/modules/report/pdfReportGenerator';
...
export function DemoPagePdfGenerator() {
  const auth = useAuth();
  ...
  return (
    <Box display="flex" flexDirection="column" minHeight="100vh">
      ...
      <Box flex="1" p={4} width="100%" maxWidth="1200px" mx="auto">
        ...
        <PdfReportGenerator
          projectUserId={'d6ee5168-5e6c-4734-be05-4dd992ea9e5d'}
